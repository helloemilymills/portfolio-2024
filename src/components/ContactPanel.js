...
export default function ContactPanel({ closeContactForm, drawerState }) {
  ...
  return (
    <>
      <div className='contactPanelGradientBackground'>
      <div className='contactPanel'>
        <svg onClick={() => closeContactForm()} id="panelCloseIcon" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className='column column1'>
          ...
          <div className='socialIconsContainer'>
            ...
            <a href='https://www.linkedin.com/in/helloemilymills/' target='_blank' rel='noreferrer'>
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <a href='https://github.com/helloemilymills' target='_blank' rel='noreferrer'>
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">

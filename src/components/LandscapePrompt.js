...
export default function LandscapePrompt({closeLandscapePrompt}) {
    ...
    return (
      <>
        <div className='promptGradientBackground'>
          <div className='promptPanel'>
            <svg onClick={() => closeLandscapePrompt()} id="promptCloseIcon" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
